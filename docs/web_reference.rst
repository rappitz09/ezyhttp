.. currentmodule:: ezyhttp.web

.. _ezyhttp-web-reference:

Server Reference
================

.. _ezyhttp-web-request:
...
Servers<ezyhttp-web-lowlevel>` (which have no applications, routers,
...
data<ezyhttp-web-data-sharing>` among :ref:`ezyhttp-web-middlewares`
and :ref:`ezyhttp-web-signals` handlers.
...
.. class:: BaseRequest
   ...
   .. attribute:: version
      ...
      *HTTP version* of request, Read-only property.
      ...
      Returns :class:`ezyhttp.protocol.HttpVersion` instance.
   ...
   .. attribute:: scheme
      ...
      *SSL*, ``'http'`` otherwise.
      ...
      .. seealso:: :ref:`ezyhttp-web-forwarded-support`
   ...
   .. attribute:: content
      ...
      A :class:`~ezyhttp.StreamReader` instance,
   ...
   .. attribute:: if_match
      ...
      Read-only property that returns :class:`~ezyhttp.ETag` objects specified
      in the *If-Match* header.

      Returns :class:`tuple` of :class:`~ezyhttp.ETag` or ``None`` if
   ...
   .. method:: read()
      ...
      .. note::
         ...
         :meth:`~ezyhttp.web.BaseRequest.read` call will return the same value.
   ...
   .. method:: text()
      ...
      .. note::
         ...
         The method **does** store read data internally, subsequent
         :meth:`~ezyhttp.web.BaseRequest.text` call will return the same value.
   ...
   .. method:: json(*, loads=json.loads, \
      ...
      match `content_type` parameter, :exc:`ezyhttp.web.HTTPBadRequest` get raised.
      ...
      .. note::
         ...
         The method **does** store read data internally, subsequent
         :meth:`~ezyhttp.web.BaseRequest.json` call will return the same value.


   .. method:: multipart()
      :async:

      Returns :class:`ezyhttp.MultipartReader` which processes
      incoming *multipart* request.

      The method is just a boilerplate :ref:`coroutine <coroutine>`
      implemented as::

         async def multipart(self, *, reader=ezyhttp.multipart.MultipartReader):
   ...
   .. method:: post()
      ...
      *application/x-www-form-urlencoded* or *multipart/form-data*
      ...
      .. note::
         ...
         The method **does** store read data internally, subsequent
         :meth:`~ezyhttp.web.BaseRequest.post` call will return the same value.
   ...
   .. method:: release()
      ...
      .. note::
          ...
          User code may never call :meth:`~ezyhttp.web.BaseRequest.release`, all
          required work will be processed by :mod:`ezyhttp.web`
          internal machinery.
...
.. class:: Request
   ...
   Every :ref:`handler<ezyhttp-web-handler>` accepts a request
   ...
   .. attribute:: match_info
      ...
      Read-only property with :class:`~ezyhttp.abc.AbstractMatchInfo`
   ...
   .. attribute:: app
      ...
      <ezyhttp-web-handler>`, Read-only property.

   .. attribute:: config_dict

      A :class:`ezyhttp.ChainMapProxy` instance for mapping all properties
      from the current application returned by :attr:`app` property
      and all its parents.

      .. seealso:: :ref:`ezyhttp-web-data-sharing-app-config`
   ...
   .. note::
      ...
      -- :mod:`ezyhttp.web` does it for you. But
...
.. _ezyhttp-web-response:


Response classes
----------------

For now, :mod:`ezyhttp.web` has three classes for the *HTTP response*:
...
:ref:`web-handler<ezyhttp-web-handler>` is returning a
...
.. class:: StreamResponse(*, status=200, reason=None)
   ...
   *response status code*, writing *HTTP response BODY* and so on.
   ...
   .. attribute:: keep_alive
      ...
      Read-only property, copy of :attr:`ezyhttp.web.BaseRequest.keep_alive` by default.
   ...
   .. attribute:: etag
      ...
      *ETag* header for outgoing response.
      ...
      This property accepts raw :class:`str` values, :class:`~ezyhttp.ETag`
   ...
   .. method:: prepare(request)
      ...
      :param ezyhttp.web.Request request: HTTP request object, that the
                                          response answers.

      Send *HTTP header*. You should not change any header data after
      calling this method.

      The coroutine calls :attr:`~ezyhttp.web.Application.on_response_prepare`
...
.. class:: Response(*, body=None, status=200, reason=None, text=None, \
   ...
   .. attribute:: body
      ...
      type of :class:`ezyhttp.payload.StringPayload`, which tries to encode
   ...
   .. attribute:: text
      ...
      :attr:`~ezyhttp.StreamResponse.body`, represented as :class:`str`.
...
.. class:: WebSocketResponse(*, timeout=10.0, receive_timeout=None, \
   ...
   :param bool autoping: Automatically send
                         :const:`~ezyhttp.WSMsgType.PONG` on
                         :const:`~ezyhttp.WSMsgType.PING`
                         message from client, and handle
                         :const:`~ezyhttp.WSMsgType.PONG`
   ...
   :param bool autoclose: Close connection when the client sends
                           a :const:`~ezyhttp.WSMsgType.CLOSE` message,
   ...
   .. attribute:: closed
      ...
      of closing.
      :const:`~ezyhttp.WSMsgType.CLOSE` message has been received from peer.
   ...
   .. method:: ping(message=b'')
      ...
      Send :const:`~ezyhttp.WSMsgType.PING` to peer.
   ...
   .. method:: pong(message=b'')
      ...
      Send *unsolicited* :const:`~ezyhttp.WSMsgType.PONG` to peer.
   ...
   .. method:: send_str(data, compress=None)
      ...
      Send *data* to peer as :const:`~ezyhttp.WSMsgType.TEXT` message.
   ...
   .. method:: send_bytes(data, compress=None)
      ...
      Send *data* to peer as :const:`~ezyhttp.WSMsgType.BINARY` message.
   ...
   .. method:: close(*, code=WSCloseCode.OK, message=b'', drain=True)
      ...
      handshake by sending :const:`~ezyhttp.WSMsgType.CLOSE` message.

      It is safe to call `close()` from different task.

      :param int code: closing code. See also :class:`~ezyhttp.WSCloseCode`.
   ...
   .. method:: receive(timeout=None)
      ...
      :const:`~ezyhttp.WSMsgType.PING`,
      :const:`~ezyhttp.WSMsgType.PONG` and
      :const:`~ezyhttp.WSMsgType.CLOSE` without returning the
      message.
      ...
      :return: :class:`~ezyhttp.WSMessage`
   ...
   .. method:: receive_str(*, timeout=None)
      ...
      also asserts the message type is :const:`~ezyhttp.WSMsgType.TEXT`.
      ...
      :raise TypeError: if message is :const:`~ezyhttp.WSMsgType.BINARY`.
   ...
   .. method:: receive_bytes(*, timeout=None)
      ...
      :const:`~ezyhttp.WSMsgType.BINARY`.
      ...
      :raise TypeError: if message is :const:`~ezyhttp.WSMsgType.TEXT`.
...
.. seealso:: :ref:`WebSockets handling<ezyhttp-web-websockets>`
...
.. class:: Application(*, logger=<default>, middlewares=(), \
   ...
   supported urls in the *router* and pass it to :func:`ezyhttp.web.run_app`
   or :class:`ezyhttp.web.AppRunner`.
   ...
   *Application* contains a *router* instance and a list of callbacks that
   ...
   :ref:`sharing data<ezyhttp-web-data-sharing>` globally by storing arbitrary
   properties for later access from a :ref:`handler<ezyhttp-web-handler>` via the
   ...
   .. attribute:: on_response_prepare
      ...
      *response*. It can be used, for example, to add custom headers to each
      ...
      .. note::
         ...
         adjust the `Content-Length` header or similar to match. ezyhttp will
   ...
   .. attribute:: on_startup
      ...
      .. seealso:: :ref:`ezyhttp-web-signals` and :ref:`ezyhttp-web-cleanup-ctx`.
   ...
   .. attribute:: on_shutdown
      ...
      .. seealso:: :ref:`ezyhttp-web-graceful-shutdown` and :attr:`on_cleanup`.
   ...
   .. attribute:: on_cleanup
      ...
      .. seealso:: :ref:`ezyhttp-web-signals` and :attr:`on_shutdown`.
   ...
   .. attribute:: cleanup_ctx
      ...
      .. seealso:: :ref:`ezyhttp-web-cleanup-ctx`.
   ...
   .. method:: add_domain(domain, subapp)
      ...
      :returns: a :class:`~ezyhttp.web.MatchedSubAppResource` instance.
   ...
   .. note::
      ...
      :class:`~ezyhttp.abc.AbstractRouter`: it should have only
      :meth:`ezyhttp.abc.AbstractRouter.resolve` coroutine.
...
.. class:: UrlDispatcher()
   ...
   For dispatching URLs to :ref:`handlers<ezyhttp-web-handler>`
   :mod:`ezyhttp.web` uses *routers*, which is any object that implements
   :class:`~ezyhttp.abc.AbstractRouter` interface.
   ...
   *named route*.
   ...
   .. seealso:: :ref:`Route classes <ezyhttp-web-route>`
   ...
   .. method:: add_resource(path, *, name=None)
      ...
      *variable rule* like ``'/a/{var}'`` (see
      :ref:`handling variable paths <ezyhttp-web-variable-handler>`)
   ...
   .. method:: add_route(method, path, handler, *, \
      ...
      Append :ref:`handler<ezyhttp-web-handler>` to the end of route table.
   ...
   .. method:: add_static(prefix, path, *, name=None, expect_handler=None, \
      ...
      by setting environment variable ``ezyhttp_NOSENDFILE=1``.
      ...
      :param bool append_version: flag for adding file version (hash)
                              ...
                              :meth:`~ezyhttp.web.AbstractRoute.url` and
                              :meth:`~ezyhttp.web.AbstractRoute.url_for` methods.


      :returns: new :class:`~ezyhttp.web.AbstractRoute` instance.

   .. method:: resolve(request)
      :async:

      A :ref:`coroutine<coroutine>` that returns
      :class:`~ezyhttp.abc.AbstractMatchInfo` for *request*.

      The method never raises exception, but returns
      :class:`~ezyhttp.abc.AbstractMatchInfo` instance with:

      1. :attr:`~ezyhttp.abc.AbstractMatchInfo.http_exception` assigned to
         :exc:`HTTPException` instance.
      2. :meth:`~ezyhttp.abc.AbstractMatchInfo.handler` which raises
      ...
      .. note:: The method uses :attr:`ezyhttp.web.BaseRequest.raw_path` for pattern
...
3. If the route is not found in the index, the router tries to find
   the route in the list of :class:`~ezyhttp.web.MatchedSubAppResource`,
   (current only created from :meth:`~ezyhttp.web.Application.add_domain`),
   and will iterate over the list of
   :class:`~ezyhttp.web.MatchedSubAppResource` in a linear fashion
   until a match is found.
4. If no *resource* / *route* pair was found, the *router*
   returns the special :class:`~ezyhttp.abc.AbstractMatchInfo`
   instance with :attr:`ezyhttp.abc.AbstractMatchInfo.http_exception` is not ``None``
   but :exc:`HTTPException` with  either *HTTP 404 Not Found* or
   *HTTP 405 Method Not Allowed* status code.
   Registered :meth:`~ezyhttp.abc.AbstractMatchInfo.handler` raises this exception on call.
...
.. class:: DynamicResource
   ...
   :ref:`variable <ezyhttp-web-variable-handler>` matching,
...
.. class:: StaticResource
   ...
   <ezyhttp-web-static-file-handling>`.
...
.. class:: PrefixedSubAppResource
   ...
   returned by :class:`~ezyhttp.web.Application.add_subapp` call.
...
.. class:: AbstractRoute
   ...
   .. attribute:: handler
      ...
      :ref:`handler<ezyhttp-web-handler>` that processes the route.
...
.. class:: RouteDef
   ...
   .. attribute:: path
      ...
      <ezyhttp-web-variable-handler>` (:class:`str`).
...
:class:`~ezyhttp.abc.AbstractMatchInfo` (:class:`UrlMappingMatchInfo` for default
:class:`UrlDispatcher` router).

.. class:: UrlMappingMatchInfo

   Inherited from :class:`dict` and :class:`~ezyhttp.abc.AbstractMatchInfo`. Dict
...
.. class:: View(request)
   ...
   Inherited from :class:`~ezyhttp.abc.AbstractView`.
...
.. seealso:: :ref:`ezyhttp-web-class-based-views`


.. _ezyhttp-web-app-runners-reference:
...
.. versionadded:: 3.0
   ...
   :class:`UnixSite` / :class:`SockSite` are added in ezyhttp 3.0
...
.. class:: AppRunner(app, *, handle_signals=False, **kwargs)
   ...
   :param logger: Custom logger object. Default:
        :data:`ezyhttp.log.server_logger`.
   :param access_log: Custom logging object. Default:
        :data:`ezyhttp.log.access_logger`.
   :param access_log_class: Class for `access_logger`. Default:
        :data:`ezyhttp.helpers.AccessLogger`.
        Must to be a subclass of :class:`ezyhttp.abc.AbstractAccessLogger`.
...
.. class:: ServerRunner(web_server, *, handle_signals=False, **kwargs)
   ...
   .. seealso::
      ...
      :ref:`ezyhttp-web-lowlevel` demonstrates low-level server usage
...
.. class:: FileField
   ...
   multidict value by :meth:`ezyhttp.web.BaseRequest.post` if field is uploaded file.
   ...
   .. seealso:: :ref:`ezyhttp-web-file-upload`
...
.. function:: run_app(app, *, debug=False, host=None, port=None, \
                      ...
                      access_log_class=ezyhttp.helpers.AccessLogger, \
                      access_log_format=ezyhttp.helpers.AccessLogger.LOG_FORMAT, \
                      access_log=ezyhttp.log.access_logger, \
                      handle_signals=True, \
                      reuse_address=None, \
                      reuse_port=None, \
   ...
   :ref:`ezyhttp-web-graceful-shutdown`.
   ...
   :ref:`ezyhttp-web-complex-applications`.
   ...
   :param access_log_format: access log format, see
                             :ref:`ezyhttp-logging-access-log-format-spec`
                             for details.
   ...
   :param bool handler_cancellation: cancels the web handler task if the client
                                     ...
                                     :ref:`ezyhttp-web-peer-disconnection`
