...
.. _ezyhttp-client-tracing-reference:
...
.. seealso:: :ref:`ezyhttp-client-tracing` for tracing usage instructions.
...
.. class:: TraceConfig(trace_config_ctx_factory=SimpleNamespace)
   ...
   .. attribute:: on_request_start
      ...
      ``params`` is :class:`ezyhttp.TraceRequestStartParams` instance.
   ...
   .. attribute:: on_request_chunk_sent
      ...
      ``params`` is :class:`ezyhttp.TraceRequestChunkSentParams` instance.
   ...
   .. attribute:: on_response_chunk_received
      ...
      ``params`` is :class:`ezyhttp.TraceResponseChunkReceivedParams` instance.
   ...
   .. attribute:: on_request_redirect
      ...
      ``params`` is :class:`ezyhttp.TraceRequestRedirectParams` instance.
   ...
   .. attribute:: on_request_end
      ...
      ``params`` is :class:`ezyhttp.TraceRequestEndParams` instance.
   ...
   .. attribute:: on_request_exception
      ...
      ``params`` is :class:`ezyhttp.TraceRequestExceptionParams` instance.
   ...
   .. attribute:: on_connection_queued_start
      ...
      ``params`` is :class:`ezyhttp.TraceConnectionQueuedStartParams`
      instance.
   ...
   .. attribute:: on_connection_queued_end
      ...
      ``params`` is :class:`ezyhttp.TraceConnectionQueuedEndParams`
      instance.
   ...
   .. attribute:: on_connection_create_start
      ...
      ``params`` is :class:`ezyhttp.TraceConnectionCreateStartParams`
      instance.
   ...
   .. attribute:: on_connection_create_end
      ...
      ``params`` is :class:`ezyhttp.TraceConnectionCreateEndParams`
      instance.
   ...
   .. attribute:: on_connection_reuseconn
      ...
      ``params`` is :class:`ezyhttp.TraceConnectionReuseconnParams`
      instance.
   ...
   .. attribute:: on_dns_resolvehost_start
      ...
      ``params`` is :class:`ezyhttp.TraceDnsResolveHostStartParams`
      instance.
   ...
   .. attribute:: on_dns_resolvehost_end
      ...
      ``params`` is :class:`ezyhttp.TraceDnsResolveHostEndParams` instance.
   ...
   .. attribute:: on_dns_cache_hit
      ...
      ``params`` is :class:`ezyhttp.TraceDnsCacheHitParams` instance.
   ...
   .. attribute:: on_dns_cache_miss
      ...
      ``params`` is :class:`ezyhttp.TraceDnsCacheMissParams` instance.
   ...
   .. attribute:: on_request_headers_sent
      ...
      ``params`` is :class:`ezyhttp.TraceRequestHeadersSentParams` instance.
