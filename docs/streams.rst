...
``ezyhttp`` uses streams for retrieving *BODIES*:
:attr:`ezyhttp.web.BaseRequest.content` and
:attr:`ezyhttp.ClientResponse.content` are properties with stream API.
...
.. class:: StreamReader
   ...
   :attr:`ezyhttp.web.BaseRequest.content` and
   :attr:`ezyhttp.ClientResponse.content` properties for accessing raw
   BODY data.
