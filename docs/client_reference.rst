.. _ezyhttp-client-reference:

Client Reference
================

.. currentmodule:: ezyhttp
...
Usage example::
     ...
     async def main():
         async with ezyhttp.ClientSession() as client:
...
.. class:: ClientSession(base_url=None, *, \
   ...
   :param base_url: Base part of the URL (optional)
      If set, it allows to skip the base part (https://docs.ezyhttp.org) in
      request calls. If base_url includes a path (as in
      https://docs.ezyhttp.org/en/stable) the path is ignored/discarded.

      .. versionadded:: 3.8

   :param ezyhttp.BaseConnector connector: BaseConnector
   ...
   :param skip_auto_headers: set of headers for which autogeneration
      ...
      *ezyhttp* autogenerates headers like ``User-Agent`` or
   ...
   :param ezyhttp.BasicAuth auth: an object that represents HTTP Basic
                                  Authorization (optional)

   :param version: supported HTTP version, ``HTTP 1.1`` by default.

   :param cookie_jar: Cookie Jar, :class:`~ezyhttp.abc.AbstractCookieJar` instance.
      ...
      :class:`ezyhttp.DummyCookieJar` instance can be
      provided.
   ...
   :param bool raise_for_status:
      ...
      This parameter can be overridden when you making a request, e.g.::
          ...
          client_session = ezyhttp.ClientSession(raise_for_status=True)
   ...
   :param bool trust_env: Trust environment settings for proxy configuration if the parameter
      is ``True`` (``False`` by default). See :ref:`ezyhttp-client-proxy-support` for
      more information.
   ...
   :param trace_configs: A list of :class:`TraceConfig` instances used for client
                         ...
                         disabling.  See :ref:`ezyhttp-client-tracing-reference` for
                         more information.
   ...
   .. attribute:: connector
      ...
      :class:`ezyhttp.BaseConnector` derived instance used
      for the session.
   ...
   .. attribute:: cookie_jar
      ...
      The session cookies, :class:`~ezyhttp.abc.AbstractCookieJar` instance.
   ...
   .. attribute:: requote_redirect_url
      ...
      ezyhttp re quote's redirect urls by default, but some servers
   ...
   .. attribute:: auth
      ...
      :class:`~ezyhttp.BasicAuth` (optional)
   ...
   .. attribute:: trust_env
      ...
      or ~/.netrc file if present. See :ref:`ezyhttp-client-proxy-support` for
      more information.
   ...
   .. attribute:: trace_config
      ...
      tracing.  ``None`` (default) is used for request tracing
      disabling.  See :ref:`ezyhttp-client-tracing-reference` for more information.
   ...
   .. method:: request(method, url, *, params=None, data=None, json=None,\
      ...
      :param params: Mapping, iterable of tuple of *key*/*value* pairs or
                     ...
                     - :class:`str` with preferably url-encoded content
                       (**Warning:** content will not be encoded by *ezyhttp*)
      ...
      :param ezyhttp.BasicAuth auth: an object that represents HTTP
      ...
      :param int chunked: Enable chunked transfer encoding.
         ...
         to decide how to chunk data streams. If chunking is enabled, ezyhttp
      ...
      :param ezyhttp.BasicAuth proxy_auth: an object that represents proxy HTTP
                                           Basic Authorization (optional)
      ...
      :param ssl: SSL validation mode. ``None`` for default SSL check
                  ...
                  :class:`ezyhttp.Fingerprint` for fingerprint
      ...
      :param bytes fingerprint: Pass the SHA256 digest of the expected
         ...
         .. deprecated:: 3.0
            ...
            Use ``ssl=ezyhttp.Fingerprint(digest)``
   ...
   .. method:: get(url, *, allow_redirects=True, **kwargs)
      ...
      :meth:`request<ezyhttp.ClientSession.request>`
...
.. function:: request(method, url, *, params=None, data=None, \
   ...
   :param ezyhttp.protocol.HttpVersion version: Request HTTP version (optional)

   :param bool compress: Set to ``True`` if request has to be compressed
                         with deflate encoding.
                         ``False`` instructs ezyhttp to not compress data.
                         ``None`` by default (optional).
   ...
   :param ezyhttp.BaseConnector connector: BaseConnector sub-class
   ...
   Usage::
      ...
      async def fetch():
          async with ezyhttp.request('GET',
                  'http://python.org/') as resp:
              assert resp.status == 200
              print(await resp.text())


.. _ezyhttp-client-reference-connectors:

Connectors
----------

Connectors are transports for ezyhttp client API.
...
.. class:: BaseConnector(*, keepalive_timeout=15, \
   ...
   :param bool enable_cleanup_closed: some SSL servers do not properly complete
      ...
      If this parameter is set to True, ezyhttp additionally aborts underlining
   ...
   .. method:: connect(request)
      ...
      :param ezyhttp.ClientRequest request: request object
                                                   which is connection
                                                   initiator.
...
.. class:: TCPConnector(*, ssl=None, verify_ssl=True, fingerprint=None, \
   ...
   :param ezyhttp.abc.AbstractResolver resolver: custom resolver
      instance to use.  ``ezyhttp.DefaultResolver`` by
      ...
      The resolver is ``ezyhttp.ThreadedResolver`` by default,
...
.. class:: ClientResponse
   ...
   Client response returned by :meth:`ezyhttp.ClientSession.request` and family.
   ...
   *released* (see :meth:`release` method).
   ...
   .. attribute:: version
      ...
      Response's version, :class:`~ezyhttp.protocol.HttpVersion` instance.
   ...
   .. attribute:: content
      ...
      :exc:`ezyhttp.ClientPayloadError` if the response object is
   ...
   .. method:: read()
      ...
      Raise an :exc:`ezyhttp.ClientResponseError` if the data can't
      be read.
   ...
   .. method:: raise_for_status()
      ...
      Raise an :exc:`ezyhttp.ClientResponseError` if the response
   ...
   .. method:: json(*, encoding=None, loads=json.loads, \
      ...
      :exc:`ezyhttp.ContentTypeError` get raised.
      ...
      :param str content_type: specify response's content-type, if content type
         does not match raise :exc:`ezyhttp.ClientResponseError`.
   ...
   .. attribute:: request_info
       ...
       A namedtuple with request URL and headers from :class:`~ezyhttp.ClientRequest`
       object, :class:`ezyhttp.RequestInfo` instance.
...
To connect to a websocket server :func:`ezyhttp.ws_connect` or
:meth:`ezyhttp.ClientSession.ws_connect` coroutines should be used, do
...
.. class:: ClientWebSocketResponse()
   ...
   .. method:: pong(message=b'')
      ...
      Send :const:`~ezyhttp.WSMsgType.PONG` to peer.
   ...
   .. method:: close(*, code=WSCloseCode.OK, message=b'')
      ...
      :const:`~ezyhttp.WSMsgType.CLOSE` message. It waits for
...
.. class:: ClientTimeout(*, total=None, connect=None, \
   ...
   See :ref:`ezyhttp-client-timeouts` for usage examples.
...
.. class:: RequestInfo()
   ...
   A data class with request URL and headers from :class:`~ezyhttp.ClientRequest`
...
.. class:: BasicAuth(login, password='', encoding='latin1')
   ...
   e.g. *auth* parameter for :meth:`ClientSession.request() <ezyhttp.ClientSession.request>`.
...
.. class:: CookieJar(*, unsafe=False, quote_cookie=True, treat_as_secure_origin = [])
   ...
   :class:`ezyhttp.abc.AbstractCookieJar` interfaces.
...
.. class:: DummyCookieJar(*, loop=None)
   ...
   To install dummy cookie jar pass it into session instance::
      ...
      jar = ezyhttp.DummyCookieJar()
      session = ezyhttp.ClientSession(cookie_jar=DummyCookieJar())
...
.. class:: Fingerprint(digest)
   ...
   call, e.g.::
      ...
      await session.get(url, ssl=ezyhttp.Fingerprint(digest))
...
added with at least one optional argument to :meth:`add_field<ezyhttp.FormData.add_field>`
(``content_type``, ``filename``, or ``content_transfer_encoding``).
Otherwise, ``application/x-www-form-urlencoded`` is used.

:class:`FormData` instances are callable and return a :class:`ezyhttp.payload.Payload`
on being called.
...
.. class:: FormData(fields, quote_fields=True, charset=None)
   ...
   :param fields: A container for the key/value pairs of this form.
                  ...
                  for :meth:`add_fields<ezyhttp.FormData.add_fields>`.
                  ...
                  :meth:`add_field<ezyhttp.FormData.add_field>`, respectively.
...
2.0. ezyhttp defines only exceptions that covers connection handling
and server response misbehaviors.  For developer specific mistakes,
ezyhttp uses python standard exceptions like :exc:`ValueError` or
:exc:`TypeError`.
...
All exceptions are available as members of *ezyhttp* module.
...
.. class:: TooManyRedirects
   ...
   parameter ``max_redirects`` in :meth:`request<ezyhttp.ClientSession.request>`.
...
.. class:: ServerDisconnectedError
   ...
   Derived from :exc:`~ezyhttp.ServerConnectionError`
...
* :exc:`ClientError`
  ...
  * :exc:`ClientResponseError`
    ...
    * :exc:`~ezyhttp.ClientHttpProxyError`
