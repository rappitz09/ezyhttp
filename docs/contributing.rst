...
.. code-block:: shell
   ...
   $ cd ezyhttp
   $ mkvirtualenv --python=`which python3` ezyhttp
...
line of the output:
``open file:///.../ezyhttp/htmlcov/index.html``
...
https://codecov.io/gh/rappitz09/ezyhttp for looking on coverage of
...
``open file:///.../ezyhttp/docs/_build/html/index.html``.
...
*ezyhttp* project committer may ask for making a *backport* of the PR
...
1. Find *Pull Request's commit* for cherry-picking.
   ...
   *ezyhttp* does *squashing* PRs on merging, so open your PR page on
...
5. *ezyhttp* *committer* should remove *backport Git label* after
   merging the backport.

How to become an ezyhttp committer
----------------------------------
...
After positive answer ezyhttp committer creates an issue on github
