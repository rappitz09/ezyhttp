...
async def test_middleware_modifies_response(loop: Any, ezyhttp_client: Any) -> None:
...
async def test_middleware_handles_exception(loop: Any, ezyhttp_client: Any) -> None:
    async def handler(request):
...
async def test_middleware_chain(loop: Any, ezyhttp_client: Any) -> None:
    async def handler(request):
...
async def test_middleware_subapp(loop: Any, ezyhttp_client: Any) -> None:
...
@pytest.fixture
def cli(loop: Any, ezyhttp_client: Any):
    async def handler(request):
        return web.Response(text="OK")
    ...
    def wrapper(extra_middlewares):
        ...
        return ezyhttp_client(app, server_kwargs={"skip_url_asserts": True})
...
class TestNormalizePathMiddleware:
    ...
    async def test_open_redirects(
        self, append_slash: bool, remove_slash: bool, ezyhttp_client: Any
    ) -> None:
        ...
        client = await ezyhttp_client(app, server_kwargs={"skip_url_asserts": True})
...
async def test_bug_3669(ezyhttp_client: Any):
...
async def test_old_style_middleware(loop: Any, ezyhttp_client: Any) -> None:
...
async def test_new_style_middleware_class(loop: Any, ezyhttp_client: Any) -> None:
    async def handler(request):
        return web.Response(body=b"OK")
...
async def test_new_style_middleware_method(loop: Any, ezyhttp_client: Any) -> None:
    async def handler(request):
        return web.Response(body=b"OK")
