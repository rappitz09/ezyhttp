...
from ezyhttp import CookieJar, DummyCookieJar
...
async def test_save_load(
    ...
    file_path = pathlib.Path(str(tmp_path)) / "ezyhttp.test.cookie"
...
class TestCookieJarSafe(TestCookieJarBase):
    ...
    def test_cookie_not_expired_when_added_after_removal(self) -> None:
        # Test case for https://github.com/rappitz09/ezyhttp/issues/2084
        timestamps = [
            533588.993,
            533588.993,
            533588.993,
