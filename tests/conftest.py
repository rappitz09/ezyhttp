...
from ezyhttp.test_utils import loop_context
...
pytest_plugins: List[str] = ["ezyhttp.pytest_plugin", "pytester"]
...
def unix_sockname(tmp_path: Any, tmp_path_factory: Any):
    ...
    # Ref: https://github.com/rappitz09/ezyhttp/issues/3572
    ...
    def assert_sock_fits(sock_path):
        ...
        assert sock_path_len <= max_sock_len, (
            ...
            "See https://github.com/rappitz09/ezyhttp/issues/3572 "
            "for more info."
        ).format_map(locals())
