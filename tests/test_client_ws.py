...
import ezyhttp
from ezyhttp import client, hdrs
from ezyhttp.http import WS_KEY
from ezyhttp.streams import EofStream
...
async def test_ws_connect(ws_key: Any, loop: Any, key_data: Any) -> None:
    ...
    with mock.patch("ezyhttp.client.os") as m_os:
        with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
            m_os.urandom.return_value = key_data
            m_req.return_value = loop.create_future()
            m_req.return_value.set_result(resp)

            res = await ezyhttp.ClientSession().ws_connect(
    ...
    with mock.patch("ezyhttp.client.os") as m_os:
        with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
            ...
            with pytest.raises(client.WSServerHandshakeError):
                await ezyhttp.ClientSession().ws_connect(
...
async def test_ws_connect_custom_response(
    ...
    with mock.patch("ezyhttp.client.os") as m_os:
        with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
            ...
            res = await ezyhttp.ClientSession(
...
async def test_ws_connect_common_headers(ws_key: Any, loop: Any, key_data: Any) -> None:
    ...
    async def test_connection() -> None:
        ...
        with mock.patch("ezyhttp.client.os") as m_os:
            with mock.patch(
                "ezyhttp.client.ClientSession.request", side_effect=mock_get
            ) as m_req:
                m_os.urandom.return_value = key_data
...
async def test_close(loop: Any, ws_key: Any, key_data: Any) -> None:
    ...
    with mock.patch("ezyhttp.client.WebSocketWriter") as WebSocketWriter:
        with mock.patch("ezyhttp.client.os") as m_os:
            with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
                m_os.urandom.return_value = key_data
                m_req.return_value = loop.create_future()
                ...
                resp._reader.feed_data(
                    ezyhttp.WSMessage(ezyhttp.WSMsgType.CLOSE, b"", b""), 0
                )
    ...
    with mock.patch("ezyhttp.client.WebSocketWriter") as WebSocketWriter:
        with mock.patch("ezyhttp.client.os") as m_os:
            with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
                ...
                resp = await ezyhttp.ClientSession().ws_connect("http://test.org")
                assert not resp.closed
...
async def test_ws_connect_non_overlapped_protocols_2(
    ...
    with mock.patch("ezyhttp.client.os") as m_os:
        with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
            ...
            connector = ezyhttp.TCPConnector(force_close=True)
            res = await ezyhttp.ClientSession(connector=connector).ws_connect(
                "http://test.org", protocols=("t1", "t2", "chat")
            )
...
async def test_ws_connect_deflate_client_wbits_bad(
    ...
    with mock.patch("ezyhttp.client.os") as m_os:
        with mock.patch("ezyhttp.client.ClientSession.request") as m_req:
            ...
            with pytest.raises(client.WSServerHandshakeError):
                await ezyhttp.ClientSession().ws_connect("http://test.org", compress=15)
