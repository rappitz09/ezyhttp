...
async def test_static_file_ok(
    ezyhttp_client: Any, app_with_static_route: web.Application
) -> None:
    client = await ezyhttp_client(app_with_static_route)
...
async def test_zero_bytes_file_ok(ezyhttp_client: Any, sender: Any) -> None:
...
async def test_zero_bytes_file_mocked_native_sendfile(
    ezyhttp_client: Any, loop_with_mocked_native_sendfile: Any
) -> None:
    filepath = pathlib.Path(__file__).parent / "data.zero_bytes"
...
async def test_static_file_not_exists(ezyhttp_client: Any) -> None:
    app = web.Application()
    client = await ezyhttp_client(app)
...
async def test_static_file_name_too_long(ezyhttp_client: Any) -> None:
    app = web.Application()
    client = await ezyhttp_client(app)
...
async def test_static_file_upper_directory(ezyhttp_client: Any) -> None:
    app = web.Application()
    client = await ezyhttp_client(app)
...
async def test_static_file_with_content_type(ezyhttp_client: Any, sender: Any) -> None:
    filepath = pathlib.Path(__file__).parent / "ezyhttp.jpg"
...
async def test_static_file_ssl(
    ...
    conn = ezyhttp.TCPConnector(ssl=client_ssl_ctx)
...
async def test_static_file_directory_traversal_attack(ezyhttp_client: Any) -> None:
    dirname = pathlib.Path(__file__).parent
    relpath = "../README.rst"
...
async def test_static_file_huge(ezyhttp_client: Any, tmp_path: Any) -> None:
...
async def test_static_file_range(ezyhttp_client: Any, sender: Any) -> None:
...
async def test_static_file_range_end_bigger_than_size(ezyhttp_client: Any, sender: Any):
    filepath = pathlib.Path(__file__).parent / "ezyhttp.png"
...
async def test_static_file_range_beyond_eof(ezyhttp_client: Any, sender: Any) -> None:
    filepath = pathlib.Path(__file__).parent / "ezyhttp.png"
...
async def test_static_file_range_tail(ezyhttp_client: Any, sender: Any) -> None:
    filepath = pathlib.Path(__file__).parent / "ezyhttp.png"
...
async def test_static_file_invalid_range(ezyhttp_client: Any, sender: Any) -> None:
    filepath = pathlib.Path(__file__).parent / "ezyhttp.png"
...
async def test_static_file_compression(ezyhttp_client: Any, sender: Any) -> None:
    ...
    app = web.Application()
    app.router.add_get("/", handler)
    client = await ezyhttp_client(app, auto_decompress=False)
...
async def test_static_file_huge_cancel(ezyhttp_client: Any, tmp_path: Any) -> None:
    file_path = tmp_path / "huge_data.unknown_mime_type"
    ...
    while True:
        ...
        except ezyhttp.ClientPayloadError:
            break
...
async def test_static_file_huge_error(ezyhttp_client: Any, tmp_path: Any) -> None:
    file_path = tmp_path / "huge_data.unknown_mime_type"
