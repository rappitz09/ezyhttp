...
from ezyhttp.test_utils import (
    ezyhttpTestCase,
...
async def test_ezyhttp_client_close_is_idempotent() -> None:
...
class TestezyhttpTestCase(ezyhttpTestCase):
...
def test_testcase_no_app(testdir: Any, loop: Any) -> None:
    testdir.makepyfile(
        ...
        class InvalidTestCase(ezyhttpTestCase):
...
async def test_custom_port(loop: Any, app: Any, ezyhttp_unused_port: Any) -> None:
