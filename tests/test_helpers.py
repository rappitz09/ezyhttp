...
from ezyhttp import helpers
from ezyhttp.helpers import (
...
def test_timer_context_not_cancelled() -> None:
    with mock.patch("ezyhttp.helpers.asyncio") as m_asyncio:
...
@pytest.mark.parametrize(
    ...
    (
        ({"http_proxy": "http://ezyhttp.io/path"}, "http://ezyhttp.io/path", "http"),
        ({"https_proxy": "http://ezyhttp.io/path"}, "http://ezyhttp.io/path", "https"),
        ({"ws_proxy": "http://ezyhttp.io/path"}, "http://ezyhttp.io/path", "ws"),
        ({"wss_proxy": "http://ezyhttp.io/path"}, "http://ezyhttp.io/path", "wss"),
    ),
...
@pytest.mark.parametrize(
    ...
    (
        (
            {"https_proxy": "https://ezyhttp.io/path"},
            "https://ezyhttp.io/path",
            "https",
        ),
        ({"wss_proxy": "wss://ezyhttp.io/path"}, "wss://ezyhttp.io/path", "wss"),
    ),
    indirect=["proxy_env_vars"],
    ids=("https", "wss"),
)
...
def test_proxies_from_env_skipped(caplog, url_input, expected_scheme) -> None:
    ...
    assert caplog.record_tuples == [("ezyhttp.client", 30, log_message)]
...
@pytest.mark.parametrize(
    ...
    (
        (
            {"http_proxy": "http://user:pass@ezyhttp.io/path"},
            "http://user:pass@ezyhttp.io/path",
            "http",
        ),
    ),
    indirect=["proxy_env_vars"],
...
def test_proxies_from_env_http_with_auth(url_input, expected_scheme) -> None:
    url = URL("http://user:pass@ezyhttp.io/path")
    ret = helpers.proxies_from_env()
    assert ret.keys() == {expected_scheme}
...
@pytest.mark.parametrize(
    ...
    (
        (
            {"no_proxy": "ezyhttp.io"},
            "http://ezyhttp.io/path",
            r"Proxying is disallowed for `'ezyhttp.io'`",
        ),
        (
            {"no_proxy": "ezyhttp.io,proxy.com"},
            "http://ezyhttp.io/path",
            r"Proxying is disallowed for `'ezyhttp.io'`",
        ),
        (
            ...
            "https://ezyhttp.io/path",
            r"No proxies found for `https://ezyhttp.io/path` in the env",
        ),
        (
            {"https_proxy": "https://example.com"},
            "http://ezyhttp.io/path",
            r"No proxies found for `http://ezyhttp.io/path` in the env",
        ),
        (
            {},
            "https://ezyhttp.io/path",
...
@pytest.mark.parametrize(
    ...
    (
        ({"http_proxy": "http://example.com"}, "http://ezyhttp.io/path"),
        ({"https_proxy": "http://example.com"}, "https://ezyhttp.io/path"),
        (
