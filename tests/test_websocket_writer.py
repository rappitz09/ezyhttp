...
from ezyhttp import DataQueue, WSMessage
from ezyhttp.http import WebSocketReader, WebSocketWriter
...
async def test_concurrent_messages(
    ...
    """
    with mock.patch(
        "ezyhttp.http_websocket.WEBSOCKET_MAX_SYNC_CHUNK_SIZE", max_sync_chunk_size
    ):
        writer = WebSocketWriter(protocol, transport, compress=15)
