...
def run_app(
    ...
    *,
    ...
    if loop.get_debug() and access_log and access_log.name == "ezyhttp.access":
...
def main(argv: List[str]) -> None:
    arg_parser = ArgumentParser(
        description="ezyhttp.web Application server", prog="ezyhttp.web"
    )
    arg_parser.add_argument(
        "entry_func",
        help=(
            "Callable returning the `ezyhttp.web.Application` instance to "
