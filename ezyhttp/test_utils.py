...
import ezyhttp
from ezyhttp.client import _RequestContextManager, _WSRequestContextManager
...
class TestClient:
    ...
    To write functional tests for ezyhttp based servers.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if cookie_jar is None:
            cookie_jar = ezyhttp.CookieJar(unsafe=True)
    ...
    def session(self) -> ClientSession:
        """An internal ezyhttp.ClientSession.
    ...
    def request(
        ...
        The interface is identical to ezyhttp.ClientSession.request,
    ...
    def ws_connect(self, path: StrOrURL, **kwargs: Any) -> _WSRequestContextManager:
        ...
        The api corresponds to ezyhttp.ClientSession.ws_connect.
...
class ezyhttpTestCase(IsolatedAsyncioTestCase, ABC):
    """A base class to allow for unittest web applications using ezyhttp.

    Provides the following:

    * self.client (ezyhttp.test_utils.TestClient): an ezyhttp test client.
    * self.app (ezyhttp.web.Application): the application returned by
    ...
    async def get_application(self) -> Application:
        ...
        This method should be overridden to return the ezyhttp.web.Application
        object to test.
        """
