...
class TCPConnector(BaseConnector):
    ...
    def _warn_about_tls_in_tls(
        ...
        warnings.warn(
            ...
            "* https://docs.ezyhttp.org/en/stable/client_advanced.html#proxy-support\n"
            "* https://github.com/rappitz09/ezyhttp/discussions/6044\n",
            RuntimeWarning,
            source=self,
    ...
    async def _create_direct_connection(
        ...
        *,
        ...
        # See https://github.com/rappitz09/ezyhttp/pull/7364.
        if host.endswith(".."):
            host = host.rstrip(".") + "."
        port = req.port
        ...
        for hinfo in hosts:
            ...
            # See https://github.com/rappitz09/ezyhttp/issues/3636
            server_hostname = (
